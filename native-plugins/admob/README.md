...
> Buff vendors upstream v1.3.4 from
> [blessedzulu/nativephp-admob](https://github.com/blessedzulu/nativephp-admob)
> at commit `e85ac7fe27211b2715ffb2fa98663164d029c15f`. The MIT license and upstream
> namespaces are preserved; the local fork adds NativePHP 4.3 compatibility and
> a manually gated banner-only integration.
...
// Upstream quick reference. Buff's fork removes automatic initialization and
// routes its banner through the app coordinator's entitlement/consent gates.
