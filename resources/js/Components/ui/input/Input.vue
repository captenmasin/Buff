...
<template>
    <input
        ...
        :value="inputValue"
        :class="cn(
            'w-full rounded-md border border-border bg-muted px-3 py-3 text-base outline-none transition placeholder:text-muted-foreground/70 focus:border-ring disabled:cursor-not-allowed disabled:opacity-60',
            props.class,
        )"
        @input="updateValue"
    >
