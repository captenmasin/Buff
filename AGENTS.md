...
- Always use Dia for browser interactions performed through Computer Use. Never use Google Chrome unless the user explicitly overrides this preference in the current request.
